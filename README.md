...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/openapi-core-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12574&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/openapi-core-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `openapi-core` can be installed with:

```
conda install openapi-core
```

It is possible to list all of the versions of `openapi-core` available on your platform with:
